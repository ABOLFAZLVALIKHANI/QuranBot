...
from django_tgbot_vip.state_manager import update_types
from django_tgbot_vip.types import chat
from . import BasicType, chatMemberUpdated , chatJoinRequest
from . import message, inlinequery, choseninlineresult, callbackquery, shippingquery, precheckoutquery, poll, pollanswer , chat
...
class Update(BasicType):
    ...
    def type(self):
        field_checks = {
            ...
            'my_chat_member': update_types.MyChatMember,
            'chat_member': update_types.ChatMember,
            'chat_join_request': update_types.ChatJoinRequest,
        }
    ...
    def get_my_chat_member(self) -> chatMemberUpdated.ChatMemberUpdated :
        return getattr(self , 'my_chat_member' , None  )

    def get_chat_member(self) -> chatMemberUpdated.ChatMemberUpdated :
        return getattr(self , 'chat_member' , None  )

    def get_chat_join_request(self) -> chatJoinRequest.ChatJoinRequest :
        return getattr(self , 'chat_join_request' , None  )