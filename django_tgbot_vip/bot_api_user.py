...
from django_tgbot_vip.exceptions import BotAPIRequestFailure, APIInputError
from django_tgbot_vip.types.botcommand import BotCommand
from django_tgbot_vip.types.chat import Chat
from django_tgbot_vip.types.chatmember import ChatMember
from django_tgbot_vip.types.file import File
from django_tgbot_vip.types.forcereply import ForceReply
from django_tgbot_vip.types.inlinekeyboardmarkup import InlineKeyboardMarkup
from django_tgbot_vip.types.message import Message
from django_tgbot_vip.types.messageentity import MessageEntity
from django_tgbot_vip.types.poll import Poll
...
from django_tgbot_vip.types.stickerset import StickerSet
from django_tgbot_vip.types.update import Update
from django_tgbot_vip.types.user import User
from django_tgbot_vip.types.userprofilephotos import UserProfilePhotos 
from django_tgbot_vip.types.chatInviteLink import ChatInviteLink
...
class BotAPIUser:
    ...
    def createChatInviteLink(self , chat_id , name   , creates_join_request =None ,  expire_date =None  , member_limit =None) :
        return self.request_and_result(create_params_from_args(locals()), ChatInviteLink )
